...
fetch('http://localhost:8000/cricket-store/api/addresses')
  .then((res) => res.json())
  .then((addressData) => {
    // Address content div
    ...
    fetch('http://localhost:8000/cricket-store/api/cards')
      .then((res) => res.json())
      .then((paymentData) => {
        // Payment content div
        ...
        placeOrderButton.addEventListener('click', () => {
          fetch('http://localhost:8000/cricket-store/api/order/place', {
            method: 'POST',
            headers: {
