...
insert into USERS (first_name, last_name, email_address, admin, recent_book_id, basket_total) VALUES ('Matt', 'Robinson', 'up2022742@port.ac.uk', True, 1, 0.0);
...
-- I don't think the relationship stuff works... returning the following.
