...
<script>
  ...
  function updateContent(event) {
    ...
    if (event.target.checked) {
      let userDataTable = document.getElementById('userTable');
      let userDataTableWrapper = document.getElementById('userTable_wrapper');

      userDataTable.style.display = 'none';
      userDataTableWrapper.style.display = 'none';
      ...
      let userDataTable = document.getElementById('userTable');
      let userDataTableWrapper = document.getElementById('userTable_wrapper');
      userDataTable.style.display = 'inline-table';
      userDataTableWrapper.style.display = 'block';
        ...
        createdCell: function (cell, cellData, rowData, rowIndex, colIndex) {
          $(cell).on("dblclick", {
            ...
            statusSelect.onchange = function (event) {
              updateStatus(rowData, e.target, rowIndex, colIndex, event)
            };
  ...
  <c:choose>
    ...
    $('#userTable tbody').on('click', 'td.dt-control', function () {
      ...
      if (row.child.isShown()) {
        ...
        row.data().orderHasBookCollection.forEach(item => {
